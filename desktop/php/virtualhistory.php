...
$plugin = plugin::byId('virtualhistory');
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">{{Nom de l'équipement virtualhistory}}</label>
                    <div class="col-sm-3">
...
<div role="tabpanel" class="tab-pane" id="commandtab">
    <a class="btn btn-default btn-sm pull-right" id="bt_addvirtualhistoryInfo"><i class="fa fa-plus-circle"></i> {{Ajouter une info virtuelle}}</a>
    <a class="btn btn-default btn-sm  pull-right" id="bt_addvirtualhistoryAction"><i class="fa fa-plus-circle"></i> {{Ajouter une commande virtuelle}}</a><br/><br/>
...
<?php include_file('desktop', 'virtualhistory', 'js', 'virtualhistory');?>
